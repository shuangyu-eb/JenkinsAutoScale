...
public class JobApi {
  ...
  public void getJob(){
    try {
      // 获取 Job 信息
      JobWithDetails job = jenkinsServer.getJob("wenda-efs-test");
      // 获取 Job 名称
  ...
  public void getMavenJob(){
    try {
      // 获取 Job 信息
      MavenJobWithDetails job = jenkinsServer.getMavenJob("wenda-efs-test");
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
  ...
  public void getJobConfig(){
    try {
      String xml = jenkinsServer.getJobXml("wenda-efs-test");
  ...
  public void buildJob(){
    try {
      jenkinsServer.getJob("wenda-efs-test").build();
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
  ...
  public void buildParamJob(){
    try {
      ...
      // 执行 build 任务
      jenkinsServer.getJob("wenda-efs-test").build(param);
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
  ...
  public void stopLastJobBuild(){
    try {
      // 获取最后的 build 信息
      Build build = jenkinsServer.getJob("wenda-efs-test").getLastBuild();
      // 停止最后的 build
      build.Stop();
    } catch (IOException e) {
      e.printStackTrace();
  ...
  public void deleteJob(){
    try {
      jenkinsServer.deleteJob("wenda-efs-test");
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
  ...
  public void disableJob(){
    try {
      jenkinsServer.disableJob("wenda-efs-test");
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
  ...
  public void enableJob(){
    try {
      jenkinsServer.enableJob("wenda-efs-test");
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
